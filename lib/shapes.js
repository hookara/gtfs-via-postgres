...
const beforeAll = (opt) => `\
CREATE TABLE IF NOT EXISTS "${opt.schema}".shapes (
...
CREATE INDEX IF NOT EXISTS shapes_by_shape_id ON "${opt.schema}".shapes (shape_id);
CREATE INDEX IF NOT EXISTS shapes_by_sequence ON "${opt.schema}".shapes (shape_id, shape_pt_sequence);
