...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'pickup_drop_off_type') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'timepoint_v') THEN
...
CREATE TABLE IF NOT EXISTS "${opt.schema}".stop_times (
...
CREATE INDEX IF NOT EXISTS idx_trip_id ON "${opt.schema}".stop_times (trip_id);
CREATE INDEX IF NOT EXISTS idx_stop_od ON "${opt.schema}".stop_times (stop_id);
...
CREATE INDEX IF NOT EXISTS idx_stop_sequence_consec ON "${opt.schema}".stop_times (stop_sequence_consec);
CREATE INDEX IF NOT EXISTS idx_trip_id_stop_sequence_consec ON "${opt.schema}".stop_times (trip_id, stop_sequence_consec);
CREATE INDEX IF NOT EXISTS idx_arrival_time ON "${opt.schema}".stop_times (arrival_time);
CREATE INDEX IF NOT EXISTS idx_departure_time ON "${opt.schema}".stop_times (departure_time);
